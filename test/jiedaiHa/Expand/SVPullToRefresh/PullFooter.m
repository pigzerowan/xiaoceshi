...
-(void)setFooterFrame:(UIScrollView *)scrollView{
    self.frame = CGRectMake(0, 0, scrollView.superview.frame.size.width, SVInfiniteScrollingViewHeight);
    scrollView.infiniteScrollingView.frame = CGRectMake(0, scrollView.superview.frame.size.height, scrollView.superview.frame.size.width, SVInfiniteScrollingViewHeight);
    @weakify(scrollView);
    [[RACObserve(scrollView, contentSize) filter:^BOOL(id value) {
        ...
        @strongify(scrollView);
        scrollView.infiniteScrollingView.frame = CGRectMake(0, scrollView.contentSize.height, scrollView.superview.frame.size.width, SVInfiniteScrollingViewHeight);
    }];
}
