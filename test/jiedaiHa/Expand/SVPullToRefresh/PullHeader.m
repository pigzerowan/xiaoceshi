...
-(void)setHeaderFrame:(UIScrollView *)scrollView{
    ...
    self.frame = CGRectMake(0, 0, scrollView.superview.frame.size.width, SVPullToRefreshViewHeight);
    scrollView.pullToRefreshView.frame = CGRectMake(0, - SVPullToRefreshViewHeight, scrollView.superview.frame.size.width, SVPullToRefreshViewHeight);
}
